// Extracted from riscv-sodor

package olinguitochip.platform.olinguito.constants
{
  import Chisel._
  import olinguitochip.util._
   import scala.math._

  object RISCVConstants extends RISCVConstants
  ...
  object PrivilegedConstants extends PrivilegedConstants
