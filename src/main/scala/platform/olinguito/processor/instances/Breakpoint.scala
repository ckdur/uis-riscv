...
class BPControl(implicit p: Parameters) extends OlinguitoBundle()(p) {
...
class BP(implicit p: Parameters) extends OlinguitoBundle()(p) {
...
class BreakpointUnit(n: Int)(implicit p: Parameters) extends OlinguitoModule()(p) {
  val io = new Bundle {
